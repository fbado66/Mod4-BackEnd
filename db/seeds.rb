...
# -------------------Array for Images  -----------------------------------
search_house = Unsplash::Photo.search("house")
houses_pics = search_house.map{|pic| {url: pic[:urls][:small], alt:pic[:alt_description]  } }

search_flat = Unsplash::Photo.search("flat")
flat_pics = search_flat.map{|pic| {url: pic[:urls][:small], alt:pic[:alt_description]  } }
...
listing_16 = Listing.create(title: 'Pittsburgh, Pennsylvania, United States', catch_phrase: '"Million Dollar View at a Terrific Price!" Guest', details: 'Welcome to brand new Oak Cabin;3 bedroom/2 bathroom eclectic home filled with wood and boho vibe.We are located in the heart of Pocono Mountains in quiet neighborhood close to all attraction, such a skiing, hiking, kayaking, waterfall, waterparks. The home is perfect gateway busy city life.Best suited for couples/friends or small families with older kids.If you are homebody its perfect stay for you;relax at home with your loved ones or venture out to explore the Pocono Mountains', image_1_url: flat_pics.sample[:url], image_2_url: room_pics.sample[:url], image_3_url: bedroom_pics.sample[:url], image_4_url: kitchen_pics.sample[:url], image_5_url: flat_pics.sample[:url], price: 159, description: "The cabin has an open floor concept. Downstairs offers a very large
common space that includes living room/dining room combo with a kitchen, full bath (with standing shower) & a bedroom with a queen bed. The living room has a large fireplace you are welcome to bring wood & use; the hanging chair is a favorite spot to lounge for all but there’s also a comfy couch and oversized ottoman chair. Plenty of room to relax, talk or play for hours. We have some board games for you.", host_info: 'Marlon typically responds within an hour')

listing_17 = Listing.create(title: 'Pittsburgh, Pennsylvania, United States', catch_phrase: 'Walk to Attractions. Downtown View. Stay in Style', details: 'Amenities include - Professional cleaning after each stay. High speed internet for work, school, and play. Complimentary, on-site garage parking. In-house gym. Exceptional customer service and experienced hosts who will be there when you need us.', image_1_url: flat_pics.sample[:url], image_2_url: room_pics.sample[:url], image_3_url: bedroom_pics.sample[:url], image_4_url: kitchen_pics.sample[:url], image_5_url: bathroom_pics.sample[:url], price: 147, description: "Enjoy the foosball table and other games in the loft. Sing your heart out in the karaoke machine!", host_info: 'Steph & Elizabeth typically responds within an hour')

listing_18 = Listing.create(title: 'Pittsburgh, Pennsylvania, United States', catch_phrase: 'New, clean private suite in the East End', details: 'Amazing views, rooftop patio, contemporary design and furnishings are just the beginning for your amazing stay at our cliffside paradise. This architecturally stunning home offers a fully equipped kitchen, two decks to dine and relax on. Beyond its walls, you can visit the nearby Station Square shops and restaurants, Monongahela Incline, Pittsburgh Zoo and PPG Aquarium, Warhol Museum, the Rivers Casino, or watch the Penguins at PPG Arena, Steelers at Heinz Field, and the Pirates at PNC Park!', image_1_url: flat_pics.sample[:url], image_2_url: room_pics.sample[:url], image_3_url: bedroom_pics.sample[:url], image_4_url: kitchen_pics.sample[:url], image_5_url: flat_pics.sample[:url], price: 129, description: "Family and friends can come together at this charming 3-bedroom home overlooking the city of champions! The Roanoke Trail starts across the street from the house where you can get more amazing good views and ample exercise. Please note that the home will be furnished with contemporary furnishings, and will be a WOW (thus the photos without furniture, but expect photos by late November). Hot tub coming in late FEBRUARY due to supply chain constraints (if you require the hot tub for your stay, please check with us before booking)! Our first bookings will occur in January, 2021.", host_info: 'Annie typically responds within an hour')
...
listing_category_6 = ListingCategory.create(listing_id: 6, category_id: 1)
...
listing_category_11 = ListingCategory.create(listing_id: 11, category_id: 2)
listing_category_12 = ListingCategory.create(listing_id: 12, category_id: 2)
...
listing_category_16 = ListingCategory.create(listing_id: 16, category_id: 3)
listing_category_17 = ListingCategory.create(listing_id: 17, category_id: 3)
listing_category_18 = ListingCategory.create(listing_id: 18, category_id: 3)
